# frontend-homework-5
#### Simple homework for students №5

В этом репозитории содержится условие варианта №5 домашнего задания. Чтобы начать с ним работать, вам необходимо склонировать репозиторий к себе на компьютер и перейти в ветку своего варианта.
...
Напишите функцию `intersection`, которая будет принимать на вход несколько массивов и находить их пересечение (считать что `NaN` равны друг другу)
