# frontend-homework-14
#### Simple homework for students №14

В этом репозитории содержится условие варианта №14 домашнего задания. Чтобы начать с ним работать, вам необходимо склонировать репозиторий к себе на компьютер и перейти в ветку своего варианта.
...
Напишите функцию `union`, которая будет принимать на вход несколько массивов и находить их объединение. Если какие-то элементы присутствуют во всех массивах, учитывать их один раз. Считать `NaN` одним и тем же (`NaN === NaN`)
