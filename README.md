...
#### Simple homework for students №12

В этом репозитории содержится условие варианта №12 домашнего задания. Чтобы начать с ним работать, вам необходимо склонировать репозиторий к себе на компьютер и перейти в ветку своего варианта.
...
Напишите функцию `toUpperCase`, которая сделает заглавной первую букву каждого слова строки, а остальные буквы сделает строчными
